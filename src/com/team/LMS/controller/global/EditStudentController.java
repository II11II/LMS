...
public class EditStudentController {
    ...
    @FXML
    private TextField editStudentIDTextField;
    @FXML
    private Button editStudentSearchBtn;
    @FXML
    private  TextField editStudentFirstNameTextField;
    @FXML
    private  TextField editStudentLastNameTextField;
    @FXML
    private Button editStudentCancelBtn;
    @FXML
    private Button editStudentOKBtn;
    ...
    public void editStudentSearch() throws SQLException {
    ...
    public void editStudentOk() throws SQLException {
        Student student;
        student = new Student();
        if (!editStudentFirstNameTextField.getText().equals("")) {
            student.setFirstName(editStudentFirstNameTextField.getText());
            student.setLastName(editStudentLastNameTextField.getText());
            student.modifyStudent(editStudentIDTextField.getText(), editStudentFirstNameTextField.getText(), editStudentLastNameTextField.getText());
